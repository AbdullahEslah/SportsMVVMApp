...
//  TableView
//
//  Created by Macbook on 04/06/2022.
//
...
extension SCNetworkReachabilityFlags {
    ...
    typealias Connection = InternetConnection.Connection
...
private class ReachabilityWeakifier {
    weak var reachability: InternetConnection?
    init(reachability: InternetConnection) {
